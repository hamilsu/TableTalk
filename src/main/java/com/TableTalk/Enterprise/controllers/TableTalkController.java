...
//        user.setAvailableRooms(listOfRooms);
    ...
    public String room(Model model, @PathVariable("id") int id) throws IOException, ParseException {
...
//        Stuff to format the date
        ...
        Room room = new Room();
        room.setId(1);
        room.setAddress("123 Main Street");
        room.setListOfPlayers(list);
        room.setFinalizedDate(dateTime);
        room.setGameId("Ad9NDUFxmt");
